import createCheckerContext from '../../decorators/createCheckerContext'
import {
...
describe('createCheckerContext', () => {
  it('createCheckerContext', () => {
    ...
    expect(createCheckerContext(moduleName, checker, converter)).toStrictEqual([checker, converter])
  })
})
